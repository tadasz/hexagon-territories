...
| A1 | Ambiguity | LOW | `plan.md` "Owner actions", `apps/ios/project.yml`, `quickstart.md` | Owner placeholders (bundle id `com.natureexplorer.app`, `DEVELOPMENT_TEAM`) were intentional and labelled. | Resolved 2026-09-07: bundle id confirmed final (T054); `DEVELOPMENT_TEAM` follows the App ID (T051). |
