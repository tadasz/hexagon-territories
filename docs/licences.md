...
| commander (npm; CLI parser of `@nature/walk-sim`, developer tooling, not shipped) | MIT | — | approved (feature 003) |
| fast-xml-parser (npm; GPX parser of `@nature/walk-sim`, developer tooling, not shipped) | MIT | — | approved (feature 003) |
| `packages/walk-sim/samples/*.gpx` (three synthetic tracks around Kaunas generated by `samples:generate`; no recorded or third-party data) | repository licence | — | not an asset: generated, no third-party data (feature 003) |
